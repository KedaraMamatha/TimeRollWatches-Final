      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="logout">Logout</a></li>
		  <li>&nbsp; &nbsp; &nbsp; &nbsp;</li>
		   ...
		   <li> <button type="button" class="btn btn-primary btn-s" style="background-color:red">TimeRollWatches</button></li>
		    <li>&nbsp; &nbsp; &nbsp; &nbsp;</li>
      </ul>
    </div>
  </div>
...
<form:option value="Select the Category of Product "></form:option>
<form:option value="Classic Watches"></form:option>
<form:option value="Sport Watches"></form:option>
<form:option value="Design Watches"></form:option>
<form:option value="Aviator"></form:option>
<form:option value="Chronograph Watches"></form:option>
<form:option value="Mechanical Watches"></form:option>
</form:select></td>
</tr>
<tr><td><br></br></td></tr>
<tr>
...
<form:option value="Select the Type of Product"></form:option>
<form:option value="Men's Wear"></form:option>
<form:option value="Women's Wear"></form:option>
<form:option value="Kid's Wear"></form:option>
</form:select></td>
</tr>
<tr><td><br></br></td></tr>
<tr>
...
<form:option value="Select the Brand"></form:option>
<form:option value="Abeler & Soehne">Abeler & Soehne</form:option>
<form:option value="Rolex">Rolex</form:option>
<form:option value="Swiss Military Hanowa">Swiss Military Hanowa</form:option>
<form:option value="Cartier">Cartier</form:option>
<form:option value="Omega">Omega</form:option>
<form:option value="Disney">Disney</form:option>
<form:option value="Olivia Pratt">Olivia Pratt</form:option>
<form:option value="Burgi">Burgi</form:option>
</form:select></td>
</tr>
<tr><td><br></br></td></tr>
<tr>
